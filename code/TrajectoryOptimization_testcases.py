...
def solve_and_plot_trajectories(var, time, n, title=''):
    ...
    # P_1 = [P * mass for P in P_1]  # Handle mass factor within the optimizer so that it is using the correct power value
    # P_2 = [P * mass for P in P_2]
    # P_inf = [P * mass for P in P_inf]
    plt.figure(n)
    plt.subplot(511)
